...
req:any[];
  ...
  updateReq(requirment){
    this.requirmentservice.selectedRequirment=requirment;
    console.log(this.requirmentservice.selectedRequirment);
    this.router.navigateByUrl("/updateform");
  }

  addreqschedule(data){
    this.requirmentservice.selectedRequirment=data;
    this.router.navigateByUrl("/requirmentScheduling");
  }
}
